...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['upload'])) {
    if (isset($_FILES['profile_pic']) && $_FILES['profile_pic']['error'] === 0) {
        ...
        if (move_uploaded_file($_FILES['profile_pic']['tmp_name'], 'uploads/' . $filename)) {
            ...
            exit();
        } else { $msg = "Failed to upload image file."; }
    } else { $msg = "Please select a valid image."; }
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="container">
        <a href="user_home.php" class="back-link">Back</a>
        ...
        <div class="layout-container">
            <div class="info-details">
                ...
                <p style="padding-left:10px;"><strong>Email:</strong> <?php echo htmlspecialchars($user['email']); ?>
                </p>
            </div>
